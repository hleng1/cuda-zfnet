...
int main(int argc, char **argv) {
  ...
  // layer 1: 110 * 110 * 96
  dim3 layer_1_grid_dim(96, 1, 1);
  dim3 layer_1_block_dim(110, 110);

  printf("Running conv_1 ...\n");
  run_conv_1<<<layer_1_grid_dim, layer_1_block_dim>>>(d_layer_1_input, d_layer_1_weights, d_layer_2_input);
